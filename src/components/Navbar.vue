                ...
                <ul class="navbar-nav ml-auto ">
                    ...
                    <li class="nav-item dropdown" v-if="checkUser">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="padding: 5px 0px 5px 1px;">
                        ...
                        <router-link class="dropdown-item drp_pd" to="/dashboard/my-cart">My Cart</router-link>
                        ...
                        <router-link class="dropdown-item drp_pd" to="/dashboard/merchant/restaurants" v-if="checkUser &&  checkUserType == 'merchant'">My Restaunrants</router-link>
