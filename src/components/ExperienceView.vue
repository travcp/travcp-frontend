<template lang="lang">
    <div class="ExperienceView">
        ...
        <div id='vrview' v-if="experience.vr_video">
            <iframe allowfullscreen="true" scrolling="no" width="100%" height="400" style="border: 0px;"
                :src="'https://storage.googleapis.com/vrview/2.0/index.html?&images='+ experience.vr_video + '&is_stereo=true'">
            </iframe>
        </div>
        <section class="project_area nagoya"
            v-if="!experience.vr_video && experience.images && experience.images.length > 0"
            :style="{background: 'url(' + experience.images[0].image + ')', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}"
        ...
        <section class="project_area default_background"
            style="background-repeat: no-repeat;background-size: cover;background-position: center;" v-else>
            <div class="container">
            </div>
        </section>
        <div class="container">
            ...
            <div class="digital_feature blog_part">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-7 col-lg-7 blog_content" v-else>
                        <h3 style="text-transform: capitalize;;font-size: 30px;">
                            ...
                            <a href="javascript:void(0)" v-if="FavoritesExperience.length"
                                title="Remove from favourites" style="color: #f81894"
                                @click="removeFavoriteExeperience(experience.id)">
                                <i class="fa fa-heart"></i>
                            </a>
                            <a href="javascript:void(0)" v-else title="Add to favourites" style="color: #f81894"
                                @click="postFavoriteExeperience(experience.id)"><i class="far fa-heart"></i>

                            </a>
                        </h3>
                        <h1 style="text-transform: capitalize;font-size: 24px;margin-bottom: 10px;">
                            {{ experience.city }}</h1>

                        <router-link
                            :to="'/merchant/profile/' + experience.merchant_id + '/' + experience.contact_email">
                            <h6>
                            ...
                            <div class="container">
                                <div class="row sidebar_text">
                                    ...
                                    <div class="col-md-12" style="position: absolute;text-align: right;right: 30px;">
                                        ...
                                        <img v-if="experience.security == 'secure'" src="../assets/travv/protected.png"
                                            width="56" />
                                    ...
                                    <div class="col-md-12 booking-action">
                                        <form @submit.prevent="bookExperience" v-if="!checkBookingStatus">
                                            ...
                                            <div v-if="experience.experience_type == 'sourvenirs'">
                                                <input type="text" name="deliveryAddress"
                                                    v-validate="'required|min:5' ? experience.experience_type == 'sourvenirs' : ''"
                                                    v-model="delivery_address"
                                                    placeholder="Address you'd like the item delivered to"
                                                    class="form-control">
                                                <span>{{ errors.first('deliveryAddress') }}</span>
                                            </div>
                                            <!-- <date-picker name="date"
                                                v-validate="experience.experience_type == 'restaurants' ? 'required' : ''"
                                                v-model="time" range :shortcuts="shortcuts" :lang="lang" v-else>
                                            </date-picker> -->
                                            ...
                                            <span>{{ errors.first('date') }}</span>
                                             <div class="row">
                                                <div class="col-md-12" style="">
                                                    <div class="row">
                                                        <div :class="[experience.experience_type == 'restaurants' ? 'col-xs-6 col-md-6' : 'col-xs-6 col-md-6']"
                                                            style="margin: auto">
                                                        ...
                                                        <div class="col-xs-6 col-md-6"
                                                            v-if="experience.experience_type == 'restaurants'">
                                                            <button type="button" class="book_btn btn-block"
                                                                @click="gotoMenu">View Menu</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item"
                                                style="border-bottom: 1px solid #000" @click="chatWithMerchant">Chat
                                                with merchant</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="average_review_section">
                                ...
                                <star-rating :rating="parseFloat(experience.rating)" :read-only="true" :increment="0.01"
                                    :star-size="32"></star-rating>
                                <br>
                                <div class="row">
                                    <div class="col-2">
                                        <p class="star_range">5</p>
                                    </div>
                                    <div class="col-8">
                                        <div class="progress" style="height: 2.0rem;">
                                            <!-- { color: activeColor, fontSize: fontSize + 'px' } -->
                                            <div class="progress-bar" role="progressbar"
                                                :style="{ width: (ratings[5] / totalRatingCount) * 100 + '%', backgroundColor: '#f81894' }"
                                                aria-valuenow="55" aria-valuemin="0" aria-valuemax="100" v-if="ratings">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <p class="star_range">4</p>
                                    </div>
                                    <div class="col-8">
                                        <div class="progress" style="height: 2.0rem;">
                                            <div class="progress-bar" role="progressbar"
                                                :style="{ width: (ratings[4] / totalRatingCount) * 100 + '%', backgroundColor: '#f81894' }"
                                                aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" v-if="ratings">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <p class="star_range">3</p>
                                    </div>
                                    <div class="col-8">
                                        <div class="progress" style="height: 2.0rem;">
                                            <div class="progress-bar" role="progressbar"
                                                :style="{ width: (ratings[3] / totalRatingCount) * 100 + '%', backgroundColor: '#f81894' }"
                                                aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" v-if="ratings">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <p class="star_range">2</p>
                                    </div>
                                    <div class="col-8">
                                        <div class="progress" style="height: 2.0rem;">
                                            <div class="progress-bar" role="progressbar"
                                                :style="{ width: (ratings[2] / totalRatingCount) * 100 + '%', backgroundColor: '#f81894' }"
                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" v-if="ratings">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <p class="star_range">1</p>
                                    </div>
                                    <div class="col-8">
                                        <div class="progress" style="height: 2.0rem;">
                                            <div class="progress-bar" role="progressbar"
                                                :style="{ width: (ratings[1] / totalRatingCount) * 100 + '%', backgroundColor: '#f81894' }"
                                                aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" v-if="ratings">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                            ...
                            <div class="gst_review_content">
                                <div class="row">
                                    ...
                                    <div class="col-md-4" v-if="checkBookingStatus">
                                        <button class="btn" style="border: 2px solid #000;height: 37px;"
                                            data-toggle="modal" data-target="#writeAReviewModal"><i class="fa fa-pencil"
                                                style="color: #000;"></i> Write a Review</button>
                                        <div class="modal fade" id="writeAReviewModal" tabindex="-1" role="dialog"
                                            aria-labelledby="writeAReviewModal" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Write a
                                                            Review</h5>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12" style="margin-bottom: 40px;">
                                                                    ...
                                                                    <p class="alert alert-warning"
                                                                        v-if="!checkBookingStatus" style="margin:0;">To
                                                                        rate this Experience you need to book first</p>
                                                                    <div id="reviewStars-input" @click="toggleRatingBox"
                                                                        v-else>
                                                                        <input id="star-4" value=5 v-model="reviewStar"
                                                                            type="radio" name="reviewStars" />
                                                                        <label title="gorgeous" for="star-4"></label>

                                                                        <input id="star-3" value=4 v-model="reviewStar"
                                                                            type="radio" name="reviewStars" />
                                                                        <label title="good" for="star-3"></label>

                                                                        <input id="star-2" value=3 v-model="reviewStar"
                                                                            type="radio" name="reviewStars" />
                                                                        <label title="regular" for="star-2"></label>

                                                                        <input id="star-1" value=2 v-model="reviewStar"
                                                                            type="radio" name="reviewStars" />
                                                                        <label title="poor" for="star-1"></label>

                                                                        <input id="star-0" value=1 v-model="reviewStar"
                                                                            type="radio" name="reviewStars" />
                                                                ...
                                                                <div class="col-md-12" style="margin: auto;">
                                                                    ...
                                                                    <div id="securityStars-input"
                                                                        @click="toggleSecurityBox">
                                                                        <input id="star-2-4" value=5
                                                                            v-model="securityStar" type="radio"
                                                                            name="securityStars" />
                                                                        <label title="gorgeous" for="star-2-4"></label>

                                                                        <input id="star-2-3" value=4
                                                                            v-model="securityStar" type="radio"
                                                                            name="securityStars" />
                                                                        <label title="good" for="star-2-3"></label>

                                                                        <input id="star-2-2" value=3
                                                                            v-model="securityStar" type="radio"
                                                                            name="securityStars" />
                                                                        <label title="regular" for="star-2-2"></label>

                                                                        <input id="star-2-1" value=2
                                                                            v-model="securityStar" type="radio"
                                                                            name="securityStars" />
                                                                        <label title="poor" for="star-2-1"></label>

                                                                        <input id="star-2-0" value=1
                                                                            v-model="securityStar" type="radio"
                                                                            name="securityStars" />
                                        ...
                                        <div class="guest_review_" v-for="review in reviews.data" v-if="!review.video">
                                            <div class="row">
                                                <div class="col-2" style="text-align: center;">
                                                    <img :src="review.user.profile_image ? review.user.profile_image.image : require('@/assets/avatar.png')"
                                                        class="rounded-circle"
                                                        style="height: 50px;display: inline-block;">
                                                </div>
                                                <div class="col-8">
                                                    <p class="" style="font-family: MuseoSans;font-weight: 100;">
                                                        {{ review.user_name }}</p>
                                                    <p class="review_rev" style="margin-bottom: 10px">
                                                        <img v-for="i in review.rating" :key="i.id"
                                                            src="../assets/review-icon.svg" alt="Review icon"
                                                            style="height: 15px;">
                                                    </p>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <button type="button" v-if="checkBookingStatus" class="btn btn-primary"
                                        style="background: #f81894;border:#f81894;" data-toggle="modal"
                                        data-target="#ReviewVideoModal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" v-for="data in getSimilarExperienceData.slice(0, 4)"
                            ...
                            <a
                                ...
                                <div class="featured-card card" style="min-width: 200px;overflow: hidden;">
                                    ...
                                    <img v-else src="../assets/osaka.png" class="card-img-top featured-card-img"
                                        style="width: 100%;object-fit: cover;height: 280px;" alt="...">
                                    <div class="featured-card-footer featured_places_overlay_active"
                                        style="margin-top: -80px;padding-top: 5px;padding-bottom: 0;">
