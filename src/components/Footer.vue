  ...
  height: 41px;" src="../assets/google_play.png" />
            ...
            <div class="col-lg-3 col-md-6">
              <aside class="f_widget categories_widget">
                ...
                <ul>
                  ...
                  <li>
                    <a href="https://brimatel.com/travvcp">TravCP Blog</a>
                  </li>
                </ul>
              </aside>
            </div>
    ...
    <div class="container">
      <div class="copy_right_area">
        <div class="">
          <h5 class="changeH5">{{ $store.state.appName }}</h5>
        </div>
        <div>
          <h5 class="changeH5">© 2019 TravCP Ltd. All rights reserved</h5>
        </div>
        <div class="float-md-right">
          <ul class="nav">
            <!-- <li class="nav-item" style="float:left">© 2019 TravCP Ltd. All rights reserved</li> -->
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">
                <img
                  src="../assets/icons8-facebook-f-filled.svg"
                  style="width: 15px; margin-right: 18.8px;"
                />
