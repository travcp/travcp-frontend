                    ...
                    <div class="travv-sidebar" style="padding: 41px 0 0 50px;">
                        <div class="container">
                            <div class="row sidebar_text">
                                ...
                                <div class="col-md-12">
                                    <h3>Cost</h3>
                                    <h5>$ {{ place.price_from }} - $ {{ place.price_to }}</h5>
                                </div>
                                <div class="col-md-12">
...
<script>
    ...
    export default {
        ...
        created: function () {
            this.getPlacesById(this.$route.params['id']);
        }
    }
</script>
