<template>
  ...
  <div class="sample-body">
    ...
    <!-- left nav -->
    <div class="left-nav">
      <a href="/" target="_blank"> <img class="travv_logo" src="../../assets/travv/travv_brand_logo_overlay.png"></a>
      <br>
...
<style>
@import "/send-bird-static/css/sample-chat.css";
...
.left-nav-user-icon {
	background: url(/send-bird-static-/img/image-profile.svg) no-repeat center center;
}
.left-nav-channel{
	color: #FFF;
	text-align: left;
