<template>
<div>
    <vue-headful title="Signup | TravCP" description="Description from TravCP" />
    <Navbar />
    <div class="wrapper">
          ...
          <p>With TravCP, you get to book unique <br> spots, Experineces and also order <br> Souvernirs straight from your home.</p>-->
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="display: block">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active">
                            ...
                            <p>
                                ...
                                <br/>experiences and restaurants 
                                <br/>straight from your home.                                
                            </p>
                    ...
                    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
                        ...
                        <button class="btn btn-primary" style="background-color: grey;border-color: grey;border-radius: 100px;">--></button>
                    ...
                    <div class="col-md-12" style="padding-top: 40px;">
                        <form @submit.prevent="formSubmit">
                            <div class="form-header">
                                ...
                                <div class="alert alert-danger" role="alert" v-if="user_errors">{{ user_errors.errors.email[0] }}</div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="my-custom-floating-label">
                                        <FloatingLabel :config="{label: 'First Name *', name: 'wrapper', line: false, scale: false}">
                                            <input v-validate="'required|min:3'" v-model="first_name" type="text" name="first name" />
                                        </FloatingLabel>
                                    </div>
                                    <div style="color: #721c24;font-weight: bolder">{{ errors.first("first name") }}</div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="my-custom-floating-label">
                                        <FloatingLabel :config="{label: 'Last Name', name: 'wrapper', line: false, scale: false}">
                                            <input v-validate="'min:3'" v-model="surname" type="text" name="surname" />
                                        </FloatingLabel>
                                    </div>
                                    <div style="color: #721c24;font-weight: bolder">{{ errors.first("surname") }}</div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="my-custom-floating-label">
                                        <FloatingLabel :config="{label: 'Email *', name: 'wrapper', line: false, scale: false}">
                                    ...
                                    <p>
                                        ...
                                        <div class="my-custom-floating-label">
                                            <FloatingLabel :config="{label: 'Password *', name: 'wrapper', line: false, scale: false,  classes: {error: 'has-error'}}">
                                                <input v-validate="'required|min:6'" :type="passwordFieldType" v-model="password" name="password" />
                                            </FloatingLabel>
                                        </div>
                                    <div style="color: #721c24;font-weight: bolder">{{ errors.first("password") }}</div>


                                        <a @click="switchVisibility" v-if="eyeVisibility" role="button" class="VuePassword__Toggle" style="width: 26px;top: -45px;left: -50px;">
                                            <svg viewBox="0 0 32 32" class="VuePassword__Toggle__Icon">
                                                <path d="M16 6c-6.979 0-13.028 4.064-16 10 2.972 5.936 9.021 10 16 10s13.027-4.064 16-10c-2.972-5.936-9.021-10-16-10zM23.889 11.303c1.88 1.199 3.473 2.805 4.67 4.697-1.197 1.891-2.79 3.498-4.67 4.697-2.362 1.507-5.090 2.303-7.889 2.303s-5.527-0.796-7.889-2.303c-1.88-1.199-3.473-2.805-4.67-4.697 1.197-1.891 2.79-3.498 4.67-4.697 0.122-0.078 0.246-0.154 0.371-0.228-0.311 0.854-0.482 1.776-0.482 2.737 0 4.418 3.582 8 8 8s8-3.582 8-8c0-0.962-0.17-1.883-0.482-2.737 0.124 0.074 0.248 0.15 0.371 0.228v0zM16 13c0 1.657-1.343 3-3 3s-3-1.343-3-3 1.343-3 3-3 3 1.343 3 3z" />
                                            </svg>
                                            <!---->
                                        </a>
                                        <a @click="switchVisibility" v-else role="button" style="width: 26px;top: -45px;left: -50px;" class="VuePassword__Toggle">
                                            <!---->
                                            <svg viewBox="0 0 32 32" class="VuePassword__Toggle__Icon">
...
.form-header h3 {
    ...
    box-shadow: inset 0 -0.175em white, inset 0 -0.2em red;
    display: inline;
    font-weight: bold;
}
