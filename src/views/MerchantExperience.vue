<template>
	<div>
		<vue-headful
            title="Merchant Experience | TravvApp"
		...
		<div class="merchant_experience">
			<div class="row">
				<div class="col-md-12">
					<div class="merchant_experience_heading">
						<h1>Experiences</h1>
					</div>
				</div>
				<div class="col-md-12">
...
<style>
	...
	.merchant_experience_heading h1 {
		font-weight: bolder;
		color: #FFF;
	}
	.add_exp_btn{
	...
	.merchant_experience_card .card-body {
		background: #F81894;
		color: #FFF;
		font-weight: bolder;
	}
	.merchant_experience_card {
		margin-top: 40px;
	}
</style>