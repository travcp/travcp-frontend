    ...
    <div class="container main">
        ...
        <div class="row my-booking-left">
            <div class="col-lg-8 my-booking-header">
                ...
                <div v-if="reviews.length < 1 && !loading">
                    <empty-result>
                ...
                <div class="row" v-for="review in reviews" :key="review.id" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-9">
                        <div class="my-booking-trip-main">
                            ...
                            <div class="my-booking-trip-details">
                                ...
                                >{{ reviews.review_body }}</p>
                                <p
                                        class="my-booking-trip-details-p2"
                                ><img v-for="i in review.rating" src="../../assets/review-icon.svg" alt="Review icon" style="height: 28px;"></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            getReviews() {
                ...
                axios.get(`${this.$store.state.API_BASE}/merchants/${this.$store.state.auth.user.id}/reviews`, requestHeaders).then(response => {
